...
![left](https://www.dropbox.com/s/c9tg8ccd9zn60jr/clint-gibler.jpg?dl=1)

# [fit] *How to write code-base specific lints*
# [fit] **for correctness and security using Semgrep**
# </br>
# [fit] **_Clint Gibler_**
# [fit] **`@clintgibler`**

^
Clint is going to be giving us a demostration of the Semgrep gem and how we can use it to write lints that are specific to your code base, I'm not doing this talk justice so if you're none the wiser you'll just have to wait and see

---
[.hide-footer]
[.slidenumbers: false]

![left](https://www.dropbox.com/s/zq6e3a8cb9kvzk2/jacin-yan.jpg?dl=1)

# [fit] *Exercism: Acronym*
# </br>
# [fit] **_Jacin Yan_**
# [fit] **`@jacinjiyan`**

^
Jacin is a student at coder acadmey and he will be taking us through the Acryonm Exercism
...
^
Mike has stuck his hand up to tackle November's exercism about scoring dart throws
...
![left](https://www.dropbox.com/s/zo2nkssy34uk4td/amit-gaur.jpg?dl=1)

# [fit] *Introduction to Crystal*
# </br>
# [fit] **_Amit Gaur_**
# [fit] **`@websymphony`**

^
Amit is going to run us through an intro to crystal, as well how it compares to writing in ruby

---

![inline 4%](https://www.dropbox.com/s/6lcxixt3dtsiw3g/Twitter_logo_bird_transparent_png.png?dl=1)

# [fit] `@clintgibler`, `@websymphony`, `@jacinjiyan`, `@MikeRogers0`
## **_`@rorosyd`_**
