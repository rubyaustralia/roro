...
![left](https://avatars.githubusercontent.com/u/219664?v=4)

# [fit] *Nailing your live coding job interview in Ruby*
# </br>
# [fit] **_Tom Dalling_**
...
# [fit] *I've been meaning to try that*
# [fit] **A meander through things I learnt over the weekend**
# </br>
# [fit] **_Mathew Button_**
# [fit] **`@matpushbuttons`**
...
^
Because we so rarely have anyone sign up ahead of schedule I thought I'd make a big deal out of it
---
...
# [fit] *JWTs, what ruby developers need to know*
# [fit] **_Dan Moore_**
# [fit] **`@mooreds`**

^
Dan booked this spot waaaaay back in May so that he'd only be speaking at midnight and not 2am, what a trooper.,
- JSON Web Tokens (JWTs)
- The problem they solve is how to share identity details in a scalable, secure way.
In this talk, Dan will dive deep into that problem, as well as how JWTs should be used, both in generation and in consumption. I’ll also cover what kind of signing algorithms are available, when you should avoid a JWT and how to revoke them. I’ll also include working code samples showing how to generate or consume JWTs.
